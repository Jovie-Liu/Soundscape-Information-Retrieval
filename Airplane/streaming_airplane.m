...
% if all(YBuffer(end-judge:end) == 'voice')  && min(probBuffer(labels == 'voice',end-judge:end)) > probThreshold
%     title('voice','FontSize',20)
% elseif all(YBuffer(end-judge:end) == 'airplane') && min(probBuffer(labels == 'airplane',end-judge:end)) > probThreshold
